<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Pending.aspx.cs" Inherits="Pending" %>

<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
   
 <div  style="background-color:white;border-radius:50px;align-content: center;width:70%;align-self:center;"> <br/><br/>   <asp:ImageButton ID="Button1" runat="server" OnClick="Button1_Click2" ImageUrl="~/images/back.png" Width="3%" 
        style=" border-radius:12px;margin-left:-174px;position:absolute;" /><asp:Label ID="Label2" runat="server" Font-Bold="False" 
        style="font-family: Calibri; font-size: 32pt" Text="Pending Projects"></asp:Label>
     <br/><br/>     <br/><br/>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                       ...
                       <asp:TemplateField ItemStyle-Width="100px">
                                <ItemTemplate  >
                                    <asp:ImageButton ID="Button3" CommandArgument='<%#Eval("pid") %>' ImageUrl="~/Images/approve1.jpg" OnClick="Button3_Click"   runat="server"   style=" background-color:forestgreen;color:white;font-weight:bold;width:100%"/>
                            ...
                            <asp:TemplateField ItemStyle-Width="100px">
                                <ItemTemplate  >
                                    <asp:ImageButton ID="Button1" CommandArgument='<%#Eval("pid")%>' OnClick="Button1_Click1" ImageUrl="~/Images/approve.jpg"   runat="server"   style=" background-color:crimson;color:white;font-weight:bold;width:100%"/>
