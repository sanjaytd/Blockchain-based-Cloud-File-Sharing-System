<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Revoke_access.aspx.cs" Inherits="Revoke_access" %>
...
<asp:Content ID="body" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        ...
        <asp:Panel ID="panel1" runat="server">
           ...
           <br/><br/>
                        <asp:Label ID="Label6" runat="server" CssClass="auto-style6" Text="Revoke Access" Style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size: xx-large"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">&nbsp;&nbsp;</td>
  ...
  <tr>
            <td width="30%" align="center" colspan="2">
                <asp:Button ID="Button1" runat="server" style="width: 160px; height: 42px;border-radius: 16px;  background-color:cornflowerblue; color: black;font-weight: bold;border-color: #faf7f0;" CssClass="auto-style12" Text="Revoke" OnClick="Button1_Click"  />
